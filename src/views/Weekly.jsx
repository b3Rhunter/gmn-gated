...
<div style={{height: "100%"}}>
  ...
  <div>
    ...
    <Button shape="round" size="large" style={{ marginTop: 32, marginLeft: 10, marginRight: 10 }} await onClick={Mint}>
      Mint Weekly
    </Button>
